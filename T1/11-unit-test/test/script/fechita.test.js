...
import dateCompare from '../../src/script/fechita.js';

const date1 = '2022-11-07T00:00:00.000Z';
const date2 = '2022-11-08T00:00:00.000Z';
...
test("Fecha 1 es posterior a la actual", t => {
    const mañana = new Date((new Date()).getTime()+246060*1000);
